<?php
    ...
    class rinstal{
        ...
        public function index(){
        	$d = array(
                'data' => array(
                    'header'	=>  $this->rndr->renderHeader('Reinstalacion'),
        ...
        public function listar(array $data){ 
             $sql = "SELECT  DATE(a.fec_crea) 'Fecha registro',
                        ...
                        CONCAT('<a idreg=\"',a.id,'\" href=\"editar\" rel=\"rinstal\" action=\"upd\" title=\"Editar Mantenimiento\" class=\"btn btn-sm btn-success\"><i class=\"fa fa-pencil\"></i></a>') MODIFICAR
        ...
        public function guardar(array $data){
            ...
            $info = array(
                ...
                'idTypeAct'     =>  isset($data['idActivnew']) ? isset($data['idActivnew']) : 4,
          ...
          if( !empty($data['hidId']) ){
            ...
            $d = array(
                ...
                'file' => 'html/rinstal/respsave.html'
            );
        ...
        public function lsteqs(array $data){
            ...
            $sql = "SELECT e.id ÍTEM, e.internalNumber 'N° INTERNO', UPPER(m.label) MODELO, s.name PROYECTO,
                        '<a href=\"nuevo\" rel=\"rinstal\" action=\"sel\" title=\"Seleccionar equipo\" class=\"btn btn-sm btn-success\"><i class=\"fa fa-check\"></i></a>' SELECCIONAR
