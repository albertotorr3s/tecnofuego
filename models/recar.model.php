<?php
    ...
    class recar{
        ...
        public function index(){
        	$d = array(
                'data' => array(
                    'header'	=>  $this->rndr->renderHeader('Recargas'),
        ...
        public function listar(array $data){ 
             $sql = "SELECT  DATE(a.fec_crea) 'Fecha registro',
                        ...
                        CONCAT('<a idreg=\"',a.id,'\" href=\"editar\" rel=\"recar\" action=\"upd\" title=\"Editar Mantenimiento\" class=\"btn btn-sm btn-success\"><i class=\"fa fa-pencil\"></i></a>') MODIFICAR
        ...
        public function guardar(array $data){
            ...
            $info = array(
                ...
                'idTypeAct'     =>  isset($data['idActivnew']) ? isset($data['idActivnew']) : 3,
        ...
        public function lsteqs(array $data){
            ...
            $sql = "SELECT e.id ÍTEM, e.internalNumber 'N° INTERNO', UPPER(m.label) MODELO, s.name PROYECTO,
                        '<a href=\"nuevo\" rel=\"recar\" action=\"sel\" title=\"Seleccionar equipo\" class=\"btn btn-sm btn-success\"><i class=\"fa fa-check\"></i></a>' SELECCIONAR
